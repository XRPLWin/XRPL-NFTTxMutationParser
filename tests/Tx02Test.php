...
final class Tx02Test extends TestCase
{
    public function testNFTokenMintListBySender()
    {
        ...
        $this->assertEquals('000000007EFD66D7DA6C495613C3ABE122007097122045BBC7169B2B00000190',$parsedTransaction['nft']);
        $this->assertEquals('000000007EFD66D7DA6C495613C3ABE122007097122045BBC7169B2B00000190',$parsedTransaction['ref']['nft']);
